...
start_link(Host, Port, Password) ->
    start_link(Host, Port, Password, 100, infinity, drop, ?DEFAULT_CONNECT_TIMEOUT).

start_link(Host, Port, Password, ReconnectSleep, MaxQueueSize, QueueBehaviour) ->
    start_link(Host, Port, Password, ReconnectSleep, MaxQueueSize, QueueBehaviour, ?DEFAULT_CONNECT_TIMEOUT).

start_link(Host, Port, Password, ReconnectSleep,
           MaxQueueSize, QueueBehaviour, ConnectTimeout)
